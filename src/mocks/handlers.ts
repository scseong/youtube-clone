        ...
        items: [
          {
            ...
            snippet: {
              ...
              description:
                '최정우 포스코그룹 회장이 국내 최초로 네쌍둥이 자연 분만에 성공한 직원의 집을 찾았습니다. 9인승 풀옵션 승합차부터 육아지원금까지 억 소리나는 지원을 받았다고 하는데요. 엠빅뉴스가 직접 연락해 봤습니다.\n\n#다둥이 #포스코 #출산',
              thumbnails: {
                default: {
          ...
          },
          {
            ...
            snippet: {
              ...
              title:
                '상상 연애도 한계가 있는데… 벌써 한계에 다다른… | 조밥 곽선생 EP.2',
              description:
          ...
          },
          {
            ...
            snippet: {
              ...
              title:
                '[백종원 시장이 되다 13화] 재개장 완료한 환상의 예산시장... 뭔가 보여드리겠습니다!💪',
              description:
          ...
          },
          {
            ...
            snippet: {
              ...
              title:
                '＂우리가 도루 저지를 하다니👀?! ＂ 파이어볼러 이대은과 어깨 깡패 박재욱의 미친 활약💥｜최강야구｜JTBC 230417 방송',
              description:
          ...
          },
          {
            ...
            snippet: {
              ...
              title:
                '[SUB] 사쿠라X츠키X마시로 난생처음 K-페스티벌 가보자Go! 👊 [겁도 없꾸라] EP.21',
              description:
          ...
          },
          {
            ...
            snippet: {
              ...
              title:
                '친구 차 훔쳐서 숨긴 다음 엉터리 힌트 줘서 전혀 상관없는 곳으로 보내버리기ㅋㅋㅋㅋㅋ',
              description:
          ...
          },
          {
            ...
            snippet: {
              ...
              title:
                'KF-21 전자전기로 스텔스 잡는다? F-35B vs KF-21 항모 탑재기의 운명은!?ㅣ전 KAI 전투기 엔지니어 조종래 상무 3편',
              description:
          ...
          },
          {
            ...
            snippet: {
              ...
              title:
                '우엉을 이렇게 드셔보세요!!우엉조림은 쳐다보지도 않아요!! 오래 두고 간단하게 튀겨먹는 우엉칩(우엉찹쌀부각)Burdock chip',
              description:
              ...
              tags: ['km_우엉요리_1080p_30f_20230419_114757'],
              categoryId: '22',
              liveBroadcastContent: 'none',
              localized: {
                title:
          ...
          },
          {
            ...
            snippet: {
              ...
              title:
                '오이무침 절대 고추장, 고춧가루 넣지 마세요! 쉽고 간단하면서 맛 좋은 꿀팁 레시피.💯 평생 써먹는 오이 요리 만드는법.🥇 오이들깨무침 맛있게 만드는법',
              description:
        ...
        items: [
          ...
          },
          {
            ...
            snippet: {
              ...
              channelId: 'UCB9e3pof1o83aa0kkaoeJGA',
              title:
                '[4K] 아이브 (IVE) -“I AM” Band LIVE Concert │넌 그냥 아이브 믿으면 돼, 보이는 그대로야💗 [it’s KPOP LIVE 잇츠라이브]',
              description:
          ...
          },
          {
            ...
            snippet: {
              ...
              channelId: 'UC-uIpGINZDL-VIHQQzJW8jw',
              title:
                '빠니보틀 - 바하마 - 4라운드 Part 2 🎲✈ │지구마불 세계여행 | TEO',
              description:
                '4라운드 빠니보틀 편 바하마 여행기 Part 2 입니다.\n\n📍결과 산정 기간: ~ 4/27 (목) 오후 6시 (KST) / 조회수+(좋아요X100) 결과집계\n\n주사위 한 번에 대륙 이동 🌎지구마불 세계여행🌎\n🏷 TEO 유튜브 매주 목요일 저녁 6시\n🏷 TV판 ENA 매주 토요일 저녁 7시 50분 \n\n#빠니보틀 #바하마 #지구마불세계여행',
              thumbnails: {
                default: {
          ...
          },
          {
            ...
            snippet: {
              ...
              channelId: 'UC-uIpGINZDL-VIHQQzJW8jw',
              title:
                '곽튜브 - 뉴질랜드 - 4라운드 Part 2 🎲✈ │지구마불 세계여행 | TEO',
              description:
                '빠니보틀, 원지, 곽튜브와 함께하는 🌎지구마불 세계여행🌎\n\n4라운드 곽튜브 편 뉴질랜드 여행기 Part 2 입니다.\n\n📍결과 산정 기간: ~ 4/27 (목) 오후 6시 (KST) / 조회수+(좋아요X100) 결과집계\n\n주사위 한 번에 대륙 이동 🌎지구마불 세계여행🌎\n🏷 TEO 유튜브 매주 목요일 저녁 6시\n🏷 TV판 ENA 매주 토요일 저녁 7시 50분 \n\n#곽튜브 #뉴질랜드 #지구마불',
              thumbnails: {
                default: {
